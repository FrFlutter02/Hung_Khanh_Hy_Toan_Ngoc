        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
              icon: Image(
                ...
                color: _selectedIndex == 0 ? AppColor.green : AppColor.iconGrey,
              ),
              label: 'Search'),
          BottomNavigationBarItem(
              icon: Image(
                image: AssetImage('assets/images/carosel_icon.jpg'),
                color: _selectedIndex == 1 ? AppColor.green : AppColor.iconGrey,
              ),
              label: 'Recipe'),
          BottomNavigationBarItem(
              icon: Image(
                image: AssetImage('assets/images/user_profile_icon.jpg'),
                color: _selectedIndex == 2 ? AppColor.green : AppColor.iconGrey,
              ),
              label: 'User profile')
        ],
